...
<div id="header" class="wrapper">
    <div class="logo"><img src="images/loginLogo.png" alt="" /></a></div>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <?php 
            ...
            //     if ($page=='index' || !isset($_REQUEST['page']))
            //         include ("home.php");
            //     else
            //         include ($page.".php");
            // }
...
<div id="footer">
	<div class="wrapper">
    	<span>&copy; Copyright 2014. Pusat Kemajuan dan Hubungan Alumni UTHM.All rights reserved.</span>
    </div>
</div>
